# Tesla Tracker - Get Notified When Tesla Cars Get Listed On The Tesla Website
...
The ideal way to use this for personal use is to set it up as a cronjob using the [Pushover](https://pushover.net) service to send push notifications through the pushover app.
